    ...
    public initRoutes() {
        this.controller.openapi(
            createRoute({
                ...
                description: 'Retrieve an album by providing a direct URL to the album on Amazon Music.',
                ...
                request: {
                    query: z.object({
                        url: z
                            ...
                            .regex(
                                new RegExp('^https://music\\.amazon\\.[a-z.]+/albums/[A-Za-z0-9]+(?:/[^/?]+)?/?(?:\\?.*)?$'),
                                'Invalid Amazon Music Album URL format'
                            )
                            .openapi({
                                title: 'Amazon Music Album URL',
                                description:
                                    'A direct URL to the album on Amazon Music, e.g., https://music.amazon.com/albums/B079VSDTZP',
                                example: 'https://music.amazon.com/albums/B079VSDTZP',
                                default: 'https://music.amazon.com/albums/B079VSDTZP',
                                pattern: '^https://music\\.amazon\\.[a-z.]+/albums/[A-Za-z0-9]+(/)?(\\?.*)?$'
                            })
                    })
                },
                responses: {
