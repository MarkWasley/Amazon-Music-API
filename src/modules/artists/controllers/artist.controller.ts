    ...
    public initRoutes() {
        this.controller.openapi(
            createRoute({
                ...
                description: 'Retrieve an artist by providing a direct URL to the artist on Amazon Music.',
                ...
                request: {
                    query: z.object({
                        url: z
                            ...
                            .regex(
                                new RegExp(
                                    '^https://music\\.amazon\\.[a-z.]+/artists/[A-Za-z0-9]+(?:/[^/?]+)?/?(?:\\?.*)?$'
                                ),
                                'Invalid Amazon Music Artist URL format'
                            )

                            .openapi({
                                title: 'Amazon Music Artist URL',
                                description:
                                    'A direct URL to the album on Amazon Music, e.g., https://music.amazon.com/artists/B003AM1Q94/imagine-dragons',
                                example: 'https://music.amazon.com/artists/B003AM1Q94/imagine-dragons',
                                default: 'https://music.amazon.com/artists/B003AM1Q94/imagine-dragons',
                                pattern: '^https://music\\.amazon\\.[a-z.]+/artists/[A-Za-z0-9]+(/)?(\\?.*)?$'
                            })
                    })
                },
                responses: {
